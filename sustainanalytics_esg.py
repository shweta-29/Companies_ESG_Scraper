...
This script allows the user to scrape the ESG ratings from the SustainAnalytics website
...
def append_dict(temp : str) -> str:
    '''
    Append the SustainAnalytics dictionary with Company name, Industry Name, and its ESG Risk rating
...
for i in tqdm(range(data_length)):
    ...
    search_bar = bot.send_request_to_search_bar(df,i, xpath = '//*[@id="searchInput"]') 
    ...
    try:
        ...
        company = bot.find_element('/html/body/section[2]/section[1]/div/div[1]/div[1]/div[1]/div/h2')
        industry = bot.find_element('/html/body/section[2]/section[1]/div/div[1]/div[1]/div[2]/div[1]/p/strong')
